...
var doUpgrade = true; //Enable Upgrading of items = true, Disable Upgrading of items = false
var emaxlevel = 6; //Max level it will stop upgrading items at if enabled
var upItem = "staff"; //Add items that you want to be upgraded as they come to your inventory [always add ' ' around item and , after item]
